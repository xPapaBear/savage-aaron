...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,read_orders,write_script_tags,read_customers,write_customers,write_themes,read_themes'),
    ...
    */
    ...
    'webhooks' => [
        [
            'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'orders/paid'),
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', env('APP_URL') . '/webhook/orders-paid')
        ],
        [
            'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'customers/create'),
            'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', env('APP_URL') . '/webhook/customers-create')
        ],
        [
            'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'app/uninstalled'),
            'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', env('APP_URL') . '/webhook/app-uninstalled')
        ],
    ],
